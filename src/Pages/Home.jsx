  ...
  return (
    <section>
      <Helmet>
        ...
        <meta
          name="description"
          content="Hero Store creates powerful and innovative apps that make everyday life simpler, smarter, and more inspiring. Discover apps trusted by millions."
        />
      </Helmet>

      {/* Hero Section */}
      <section className="w-full flex flex-col items-center text-center bg-[#f5f5f5]">
        <div className="max-w-4xl mt-12 px-3">
          ...
          <p className="mt-4 text-gray-600 text-sm md:text-base">
            ...
            into digital experiences that truly make an impact. Join millions of
            users who trust our apps for productivity and creativity.
          </p>
        ...
        {/* Stats Section */}
        <section className="w-full bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-white py-12">
          <h2 className="hidden lg:block text-4xl font-bold text-center">
            Trusted By Millions, Built For You
          </h2>
          <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 py-8 text-center sm:text-left">
            <article>
